...
my ($ctx_,$_ctx,$const) = map("r$_",(10..12));
							...
							if ($flavour =~ /64/) {
###############################################################################
# setup phase of GFp_poly1305_blocks_vsx is different on 32- and 64-bit platforms,
...
Ldone_vsx:
	...
	.long	0
.size	__GFp_poly1305_blocks_vsx,.-__GFp_poly1305_blocks_vsx
